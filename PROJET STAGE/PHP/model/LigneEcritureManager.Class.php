...
class LigneEcritureManager
{
    ...
    public static function getByIdEcriture($idEcriture) // Ramène un compte en particulier (avec l'idEriture')
    {
        $db = DbConnect::getDb();
        $ligneComptable = [];
        $q = $db->query("SELECT * FROM LigneEcriture WHERE idEcriture=$idEcriture");
