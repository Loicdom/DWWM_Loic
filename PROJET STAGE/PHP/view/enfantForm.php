...
echo '<div class="formulairePersonne">
        <form action="index.php?action=enfantAction&m=' . $mode . '" method="POST">
            <div class="div-formPersonne">
                ...
                <input class="inputformPersonne" type="text" id="nomPersonne" name="nomPersonne" placeholder="Nom enfant" '; ?> pattern="^[A-ZÀ-Ý' ’-]{2,}$" <?php ' required autofocus ';
if ($mode != "ajout") {
...
if ($mode != "ajout") {
    ...
    echo '  <input type="text" id="typePersonne" name="typePersonne" hidden value = "Enfant"> '; // type personne à "Enfant" pour l'ajout
echo '      <div class="div-formPersonne"> 
                <label class="formPersonne" for="prenomPersonne">Prénom : </label>
                <input class="inputformPersonne" type="text" id="prenomPersonne" name="prenomPersonne" placeholder="Prénom enfant" '; ?> pattern="^[A-ZÀ-Ý]{1}[a-zà-ý '-]*([ |-][A-ZÀ-Ý]{1}[a-zà-ý '-]*)?$" <?php ' required ';
if ($mode != "ajout") {
...
echo '      <div class="div-formPersonne"> 
                ...
                <input class="inputformPersonne" type="date" id="dateNaissPersonne" name="dateNaissPersonne" placeholder="Date de naissance enfant" required ';
if ($mode != "ajout") {
...
echo '      <div class="div-formPersonne"> 
                ...
                <input class="inputformPersonne" type="text" id="lieuNaissPersonne" name="lieuNaissPersonne" placeholder="Lieu de naissance enfant" '; ?> pattern="^[A-ZÀ-Ý]{1}[a-zà-ý '-]*([ |-][A-ZÀ-Ý]{1}[a-zà-ý '-]*)?$" <?php ' required ';
if ($mode != "ajout") {
...
echo '      <div class="div-formPersonne"> 
                ...
                <input class="inputformPersonne" type="text" id="adressePersonne" name="adressePersonne" placeholder="Adresse enfant" required ';
if ($mode != "ajout") {
...
echo '      <div class="div-formPersonne"> 
                ...
                <input class="inputformPersonne" type="text" id="cpPersonne" name="cpPersonne" placeholder="CP enfant" '; ?> pattern="^\d{5}$" <?php ' required ';
if ($mode != "ajout") {
...
echo '      <div class="div-formPersonne"> 
                ...
                <input class="inputformPersonne" type="text" id="telPersonne" name="telPersonne" placeholder="Téléphone parent" '; ?> pattern="^0[1-9]([-. ]?[\d]{2}){4}$" <?php ' required ';
if ($mode != "ajout") {
...
echo '      <div class="div-formPersonne"> 
                <label class="formPersonne" for="paiementInscription">Moyen paiement inscription : </label>
                <input class="inputformPersonne" type="text" id="paiementInscription" name="paiementInscription" placeholder="Chèque / espèces" required ';
if ($mode != "ajout") {
...
echo '      <div class="div-formPersonne"> 
                <label class="formPersonne" for="nomRepresentantLegal">Nom représentant légal : </label>
                <input class="inputformPersonne" type="text" id="nomRepresentantLegal" name="nomRepresentantLegal" placeholder="Nom représentant légal" '; ?> pattern="^[A-ZÀ-Ý' ’-]{2,}$" <?php ' required ';
if ($mode != "ajout") {
...
echo '      <div class="div-formPersonne"> 
                <label class="formPersonne" for="prenomRepresentantLegal">Prénom représentant légal : </label>
                <input class="inputformPersonne" type="text" id="prenomRepresentantLegal" name="prenomRepresentantLegal" placeholder="Prénom représentant légal" '; ?> pattern="^[A-ZÀ-Ý]{1}[a-zà-ý '-]*([ |-][A-ZÀ-Ý]{1}[a-zà-ý '-]*)?$" <?php ' required ';
if ($mode != "ajout") {
